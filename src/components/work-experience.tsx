...
export default function WorkExperience() {
  return (
    <div className="mt-10 sm:mt-14">
      <h2 className="mb-5 font-medium text-gray-800 dark:text-neutral-200">Work experience</h2>
      {/* Timeline */}
      <div>
        {/* Item */}
        ...
        <div className="group relative flex gap-x-5">
          ...
          <div className="grow pb-8 group-last:pb-0">
            ...
            <p className="mt-1 text-sm text-gray-600 dark:text-neutral-400">
              ...
              employees if you ask me. Managers are still adapting to the growth I think, but
            ...
            <div className="mt-3">
              {/* Card */}
              <a
                className="block rounded-lg border border-gray-200 hover:shadow-sm focus:outline-none dark:border-neutral-700"
                href="#"
              >
        ...
        <div className="group relative flex gap-x-5">
          ...
          <div className="grow pb-8 group-last:pb-0">
            ...
            <p className="mt-1 text-sm text-gray-600 dark:text-neutral-400">
              Work in Slack is one of the beautiful experience I can do in my entire life. There are
              a lot of interesting thing to learn and manager respect your time and your
              personality.
            </p>
          </div>
          {/* End Right Content */}
